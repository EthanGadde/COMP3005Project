...
def Q_1(cursor, conn, execution_time):
    ...
    query = """ SELECT player_id, player_name, AVG(statsbomb_xg) as average_xg
FROM shot NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
...
def Q_2(cursor, conn, execution_time):
    ...
    query = """ SELECT player_id, player_name, COUNT(event_id) as shot_count
FROM shot NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND season_name='2020/2021'
GROUP BY player_id, player_name
...
def Q_3(cursor, conn, execution_time):
    ...
    query = """ SELECT player_id, player_name, COUNT(event_id) as first_time_shot
FROM shot NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND first_time IS true
GROUP BY player_id, player_name
ORDER BY first_time_shot DESC
"""
...
def Q_4(cursor, conn, execution_time):
    ...
    query = """SELECT team_id, team_name, COUNT(event_id) as pass_count
FROM pass NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND season_name='2020/2021'
...
def Q_5(cursor, conn, execution_time):
    ...
    query = """ 
SELECT pass_recipient_id, pass_recipient_name, COUNT(event_id) as recipient_pass_count
FROM pass NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='Premier League' AND pass_recipient_id IS NOT NULL
GROUP BY pass_recipient_id, pass_recipient_name
ORDER BY recipient_pass_count DESC
"""
...
def Q_6(cursor, conn, execution_time):
    ...
    query = """ 
SELECT team_id, team_name, COUNT(event_id) as shot_count
FROM shot NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
...
def Q_7(cursor, conn, execution_time):
    ...
    query = """ SELECT player_id, player_name, COUNT(event_id) as through_ball_count
FROM pass NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
...
def Q_8(cursor, conn, execution_time):
    ...
    query = """ 
SELECT team_id, team_name, COUNT(event_id) as through_ball_count
FROM pass NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND season_name='2020/2021' AND technique_name='Through Ball'
GROUP BY team_id, team_name
...
def Q_9(cursor, conn, execution_time):
    ...
    query = """ 
SELECT player_id, player_name, COUNT(event_id) as completed_dribble_count
FROM dribble NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND outcome_name='Complete'
GROUP BY player_id, player_name
ORDER BY completed_dribble_count DESC
"""
...
def Q_10(cursor, conn, execution_time):
    ...
    query = """ SELECT player_id, player_name, COUNT(event_id) as dribbled_past_count
FROM dribbled_past NATURAL INNER JOIN events
JOIN competitions ON competitions.competition_id=events.competition_id AND competitions.season_id=events.season_id
WHERE competition_name='La Liga' AND season_name='2020/2021'
GROUP BY player_id, player_name
